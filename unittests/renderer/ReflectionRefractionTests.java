...
public class ReflectionRefractionTests {
    ...
    public void multiObjects() {
        ...
        scene.setAmbientLight(new AmbientLight(new Color(WHITE), new Double3(0.20))).setBackground(new Color(BLUE));
        scene.geometries.add( //
                ...
                new Sphere(new Point(0, 0, -50), 50d).setEmission(new Color(blue).reduce(2))
                        .setMaterial(new Material().setKd(0.2).setKs(0.2).setShininess(100).setKt(0.5)));
        ...
        scene.geometries.add( //
                ...
                new Triangle(a, b, c) //
                        .setMaterial(new Material().setKd(0.5).setKs(0.9).setShininess(100)).setEmission(new Color(150, 20, 30)), //
                new Triangle(a, b, d) //
                        .setMaterial(new Material().setKd(0.9).setKs(0.5).setShininess(100)).setEmission(new Color(65, 35, 35)), //
                new Triangle(a, c, d) //
                        .setMaterial(new Material().setKd(0.5).setKs(0.5).setShininess(100)).setEmission(new Color(50, 20, 20)), //
        ...
        scene.lights.add( //
                new SpotLight(new Color(500, 600, 400),
                        ...
                        new Vector(-1, -1, -2)) //
                        .setKl(0.004).setKq(0.0000006).setSize(0));
