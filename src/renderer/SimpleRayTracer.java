...
public Color traceRay(Ray ray) {
    ...
    private Color calcGlobalEffects(GeoPoint gp, Ray ray, int level, Double3 k) {
        ...
        return calcGlobalEffect(constructRefractedRay( ray.getDirection(),gp.point,gp.geometry.getNormal(gp.point)), material.kT, level, k)
                .add(calcGlobalEffect(constructReflectedRay(ray.getDirection(),gp.point,gp.geometry.getNormal(gp.point)), material.kR, level, k));
    }
